...
namespace Payments.Migrations
{
    ...
    [Migration("20260912131418_SubscriptionPlanLifecycle")]
    partial class SubscriptionPlanLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Coflnet.Payments.Models.RefundedSubscriptionInvoice", b =>
                {
                    ...
                    b.ToTable("RefundedSubscriptionInvoices");
                });
            ...
            modelBuilder.Entity("Coflnet.Payments.Models.SubscriptionPlanChange", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Coflnet.Payments.Models.TierSlot", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MinecraftUuid", "Expires");

                    b.HasIndex("AssignedUserId", "MinecraftUuid", "Expires");

                    b.ToTable("TierSlots");
                });

            modelBuilder.Entity("Coflnet.Payments.Models.TierSlotGrant", b =>
                {
                    b.Property<long>("TransactionId")
                        .HasColumnType("bigint");

                    b.Property<long>("TierSlotId")
                        .HasColumnType("bigint");

                    b.Property<long>("Seconds")
                        .HasColumnType("bigint");

                    b.HasKey("TransactionId", "TierSlotId");

                    b.HasIndex("TierSlotId");

                    b.ToTable("TierSlotGrants");
                });
            ...
            modelBuilder.Entity("Coflnet.Payments.Models.UserSubscription", b =>
                {
                    ...
                    b.Property<DateTime?>("ChangeLockUntil")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<long?>("ProviderVariantId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Coflnet.Payments.Models.SubscriptionPlanChange", b =>
                {
                    b.HasOne("Coflnet.Payments.Models.Product", "PreviousProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("Coflnet.Payments.Models.TierSlotGrant", b =>
                {
                    b.HasOne("Coflnet.Payments.Models.TierSlot", "TierSlot")
                        .WithMany()
                        .HasForeignKey("TierSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Coflnet.Payments.Models.FiniteTransaction", "Transaction")
                        .WithMany()
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TierSlot");
